const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的网站', url: 'https://jiminghuadian.love' },
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '花艺交流',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'jimignhuadian.love',
  HERO_TITLE_4: '新品上线',
  HERO_TITLE_5: 'JIMING`S 作品展示',
  HERO_TITLE_LINK: 'https://jiminghuadian.love',
  ...
  INFO_CARD_URL: 'https://jiminghuadian.love', // 个人资料底部按钮链接
